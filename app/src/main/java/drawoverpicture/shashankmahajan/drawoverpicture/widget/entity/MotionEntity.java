package drawoverpicture.shashankmahajan.drawoverpicture.widget.entity;
...
import drawoverpicture.shashankmahajan.drawoverpicture.utils.MathsUtils;
import drawoverpicture.shashankmahajan.drawoverpicture.viewmodel.Layer;

import static drawoverpicture.shashankmahajan.drawoverpicture.utils.MathsUtils.pointInTriangle;

/**
 * Created by shashankmahajan on 21/02/17.
 */
...
public abstract class MotionEntity  {
        ...
        public boolean pointInLayerRect(PointF point) {
            ...
            return pointInTriangle(point, pA, pB, pC) || MathsUtils.pointInTriangle(point, pA, pD, pC);
        }
